...
<html lang="de">
  ...
  <body>
  	...
  	<p>Der Versuch dauert ungefähr 30-45 Minuten. Technische Voraussetzungen und eine genaue Anleitung finden Sie unten.</p>
    ...
    <p>Um den Versuch durchzuführen, muss die Auflösung Ihres Bildschirm mindestens 800x600 Pixel betragen. </p> <!-- Haben wir eine Mindestbildschirmgröße? -->

    <p><a target="_blank" href="java.htm">So finden Sie heraus</a>, ob Sie Java installiert haben.</p> <!-- TODO: raus löschen-->

  	<span><i>Schritt-für-Schritt-Anleitung:</i></span> <!-- TODO: raus löschen-->
  	<ol>
...
?>
     ...
     <!-- TODO: Bis hierhin Absatz raus löschen!-->
      <li>Wenn Sie am Gewinnspiel teilnehmen möchten, geben Sie bitte Ihre Mailadresse an. Andernfalls schließen Sie bitte das Fenster in Ihrem Browser, um das Experiment zu beenden.</li> <!-- TODO: Das gehört auf die letzte Seite. -->
  	</ol>

    <a href="./versuchsanleitung.php"><button>Weiter</button></a>
  	<br><br>
    <hr>
    <span id="macos"><sup>[1]</sup> Etwaige Sicherheitsabfrage bestätigen, dann in den Systemeinstellungen auf "Sicherheit" klicken. Dort auf App "Dennoch öffnen" klicken.<span><br><br> <!-- TODO: raus -->
