...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-5">Datenschutzerklärung für "ProKRep-Küchensimulation"</h1>
          ...
          <p>Mittels dieser Datenschutzerklärung möchten wir Sie im Folgenden über die Datenverarbeitung Ihrer personenbezogenen Daten (im Folgenden „Daten“) informieren, die aus dem Besuch oder der Nutzung von Funktionen unserer Webseiten resultieren.</p>
      <p>
        ...
        <p>Der Schutz Ihrer Privatsphäre ist uns ein wichtiges Anliegen. Zum Schutz Ihrer Daten trifft unser Institut eine Vielzahl an technischen und organisatorischen Maßnahmen, um eine unbefugte Kenntnisnahme und Weitergabe, Manipulation, Verlust und unbefugte Löschung wirksam verhindern zu können.</p>
        <p>Die von uns ergriffenen Maßnahmen unterliegen dabei der stetigen Aktualisierung. Wir orientieren uns dabei an den gesetzlichen Vorgaben, Best-Practice-Ansätzen sowie technischen Entwicklungen.
          Im Folgenden unterrichten wir Sie über Art, Umfang und Zweck der Erhebung, Verarbeitung und Nutzung Ihrer Daten in unserem Institut, sofern dies aus dem Besuch oder der Nutzung der Funktionen unserer Webseiten resultiert.</p>
        ...
        <p>
          ...
          <b>Email:</b> <a href="mailto:datenschutz@uni-tuebingen.de">datenschutz@uni-tuebingen.de</a></p>
            ...
            <p>Ebenfalls erheben wir wissentlich keine personenbezogenen Daten von Minderjährigen (= Personen unter 18 Jahren). In Fällen, in denen wir feststellen, dass uns personenbezogene Daten durch Minderjährige zur Verfügung gestellt wurden, löschen wir diese Daten umgehend. Erziehungsberechtigten empfehlen wir, auf die Internet-Aktivitäten der in ihrer Obhut befindlichen Minderjährigen zu achten.</p>
            ...
            <p>  Sofern Sie uns Ihre Daten freiwillig zu den im Folgenden aufgeführten Zwecken mitteilen, verarbeiten und nutzen wir diese Daten ausschließlich für die Zwecke, für die Sie uns Ihre Daten zukommen lassen haben.
            ...
            <p>  Auf unseren Webseiten setzen wir „Cookies“ ein. Cookies sind Textdateien, die auf dem Speicher des Gerätes, von dem aus Sie unsere Webseiten aufgerufen haben, platziert werden.
              Wir setzen sowohl dauerhafte Cookies als auch temporäre Cookies (sog. Session-Cookies) ein. Dauerhafte Cookies können einige Sekunden bis mehrere Jahre lang auf Ihrem Gerät gespeichert werden. Temporäre Cookies werden automatisch gelöscht, sobald Sie Ihren Browser schließen bzw. die Session beenden.</p>
            ...
            <p>  Sofern Sie nicht möchten, dass Cookies auf Ihrem Gerät gespeichert werden, können Sie Ihren Browser so einstellen, dass er Sie über die Platzierung von Cookies benachrichtigt oder diese nicht akzeptiert. Sie können auch entscheiden, ob sie nur einige wenige oder alle Kategorien von Cookies annehmen bzw. blockieren möchten. Weitere Informationen zum Umgang mit Cookies finden Sie in der Onlinehilfe Ihres verwendeten Browsers.
              Sofern Sie durch uns eingesetzte Cookies blockieren, möchten wir Sie darüber informieren, dass Sie möglicherweise einzelne Funktionen unserer Webseite nicht oder nur eingeschränkt verwenden können.</p>
            
            
              
                
                                      <h3 class="mt-5">Google Web Fonts</h3>
                    <p>Unsere Webseite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web Fonts, die von Google bereitgestellt werden. Beim Aufruf einer Seite lädt Ihr Browser die benötigten Web Fonts in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.</p>
                    <p>Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Google aufnehmen. Hierdurch erlangt Google Kenntnis darüber, dass über Ihre IP-Adresse unsere Webseite aufgerufen wurde. Die Nutzung von Google Web Fonts erfolgt im Interesse einer einheitlichen und ansprechenden Darstellung unserer Online-Angebote. Dies stellt ein berechtigtes Interesse im Sinne von Art. 6 Abs. 1 lit. f DSGVO dar.
                      ...
                      <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a href="https://developers.google.com/fonts/faq">https://developers.google.com/fonts/faq</a> und in der Datenschutzerklärung von Google: <a href="https://www.google.com/policies/privacy/">https://www.google.com/policies/privacy/</a>.</p>
                                          ...
                                          <p>Webseitenbesucher unseres Onlineauftritts haben gemäß Art. 15 DSGVO das Recht, auf Anfrage, jederzeit und kostenfrei Auskunft über Ihre in unserem Institut zu Ihrer Person verarbeiteten Daten zu erhalten. Der Umfang der Auskunft ergibt sich aus Art. 15 DSGVO.</p>
                                          <p>Ihr Auskunftsbegehren richten Sie bitte an alisa.volkert (@) uni-tuebingen.de .</p> <!-- davor: <a href="#kontakt">diesen Kontakt</a> -->
                                          ...
                                          <p>Sie haben gemäß Art. 17 DSGVO das Recht auf Löschung Ihrer Daten.
                                            ...
                                            <p>
                                              ...
                                              Wir informieren Sie darüber, dass eine vollständige Löschung erst nach Ablauf der entsprechenden Fristen der steuer- und handelsrechtlichen Vorschriften erfolgt. Bis zum Ablauf dieser Fristen und bis zur endgültigen Löschung werden Ihre Daten entsprechend gesperrt und von uns nicht weiterverarbeitet.</p>
                                              ...
                                              <p>Sie haben das Recht, jederzeit und ohne Angabe von Gründen kostenfrei die uns von Ihnen erteilte Einwilligung zur Erhebung, Verarbeitung und Nutzung Ihrer Daten für die Zukunft zu widerrufen bzw. gemäß Art. 21 DSGVO Widerspruch gegen die Verarbeitung Ihrer Daten einzulegen.
                                              </p><p>Ihren Widerruf Ihrer Einwilligung bzw. Widerspruch richten Sie bitte an <a href="#kontakt">diesen Kontakt</a>.</p>
                                            
                                                                                          <h3 class="mt-5">Recht auf Beschwerde bei einer Aufsichtsbehörde</h3>
                                              <p>Sie haben gemäß Art. 14 i.V.m. Art. 77 DSGVO das Recht auf Beschwerde bei einer Aufsichtsbehörde für den Datenschutz, sofern Sie der Ansicht sind, dass die Verarbeitung Ihrer Daten gegen die DSGVO verstößt. Die zuständige Aufsichtsbehörde ist diejenige, in dem unser Institut seinen Hauptsitz hat.</p>
                                              ...
                                              <p>Diese Datenschutzerklärung wird bei neuen gesetzlichen Vorgaben oder wesentlichen Änderungen des Funktionsumfangs unserer Webseiten mit Wirkung für die Zukunft aktualisiert. Wir empfehlen Ihnen daher, unsere Datenschutzerklärung in regelmäßigen zeitlichen Abständen durchzulesen.</p><br />
